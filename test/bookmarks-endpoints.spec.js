...
describe.only('Bookmarks Endpoints', function() {
  ...
  describe(`GET /api/bookmarks/`, () => {
    ...
    context('Given there are bookmarks in the database', () => {
      ...
      beforeEach('insert bookmarks', () => {
        return db.into('bookmark_list').insert(testBookmarks);
      });
  ...
  describe(`GET /api/bookmarks/:bookmarks_id`, () => {
    context('Given there no bookmarks', () => {
    ...
    context('Given there are bookmarks in the database', () => {
      ...
      beforeEach('insert bookmark_list', () => {
        return db.into('bookmark_list').insert(testBookmarks);
      });
  ...
  describe('DELETE /api/bookmarks/:id', () => {
    ...
    context('Given there are bookmarks in the database', () => {
      ...
      before('insert bookmark_list', () => {
        return db.into('bookmark_list').insert(testBookmarks);
      });

      it('removes the bookmark_list by ID from the store', () => {
        const idToRemove = 2;
